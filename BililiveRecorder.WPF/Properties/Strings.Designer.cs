...
namespace BililiveRecorder.WPF.Properties {
    ...
    public class Strings {
        ...
        /// <summary>
        ///   查找类似 请输入mikufans直播房间号或直播间链接 的本地化字符串。
        /// </summary>
        ...
        ///对 Timing 的修改可能会导致被mikufans服务器屏蔽、不能及时开始录制等问题。 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 不要根据文件大小/视频时间自动分段 的本地化字符串。
        /// </summary>
